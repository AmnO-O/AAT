...
class ScorerNetV2(nn.Module):
    ...
    Copy this class into submission_v2.py when deploying.
    """
...
# =============================================================================
# Extended candidate feature encoder  (CAND_DIM_V2 = 11)
# =============================================================================
...
def _encode_candidate_features_v2(action, my_r, my_c, my_radius,
    ...
    New features (indices 7-10):
      ...
      f11 dest_in_hyp_danger: 1.0 if the destination falls inside the blast zone
          ...
          Soft safety signal — not a hard gate, just a learnable penalty.
    """
    ...
    # f11: destination in hypothetical enemy danger (soft signal, not a hard gate)
