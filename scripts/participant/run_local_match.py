...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent_paths", nargs="+", default=["agent/tactical_rule_agent.py", "agent/caludefat2/agent.py", 
                                                             "agent/simple_rule_agent.py", "agent/simple_rule_agent.py"],
