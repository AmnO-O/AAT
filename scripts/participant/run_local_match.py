...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent_paths", nargs="+", default=["agent/samnu_agent.py", "agent/submission_v1/submission_v1.py", 
                                                             "agent/genius_rule_agent.py", "agent/tactical_rule_agent.py"],
